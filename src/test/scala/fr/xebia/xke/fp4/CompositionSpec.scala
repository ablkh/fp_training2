...
class CompositionSpec extends FunSpec with Matchers {
  ...
  describe("function composition") {
    ...
    lazy val f: Int => Int = x => x + 10 //TODO EXO1
    ...
    lazy val g: Int => String = _.toString //TODO EXO1
    ...
    describe("f andThen g") {
      lazy val h: (Int) => String =  f.andThen(g) //TODO EXO1
    ...
    describe("g compose f") {
      lazy val h: (Int) => String = g.compose(f) //TODO EXO1
